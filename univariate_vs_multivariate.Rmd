---
title: "Univariate Versus Multivariate"
...
p = ggdraw() +
  ...
  draw_plot_label(label = c("A", "B", "C"), x = c(0, 0.5, 0), y = c(1, 1, 0.5), size = 10)
```
...
p = p + labs(title   = 'Univariate versus multivariate',
             caption = paste0(A,' ',B,"\n",C,"\n",D,"\n")) +
  theme(plot.caption = element_text(size = 10, colour = "black", vjust = -1))
```

#### Plot
```{r, dpi=60, out.width="800", out.height="450"}
p
```

#### Save plot
```{r}
ggsave(filename = 'univariate_vs_multivariate.png', plot = p, width = 16, height = 9)
```
